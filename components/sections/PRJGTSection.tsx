...
import { SignalAnalysis } from "../visual/SignalAnalysis";
      ...
      <div className="flex flex-col gap-6 text-sm md:text-base">
        ...
        <div className="grid-border border border-zinc-900 bg-black/70 p-4">
          <div className="mb-3 flex items-center justify-between">
            <p className="font-mono text-xs md:text-sm uppercase tracking-[0.22em] text-zinc-200">
              SIGNAL ANALYSIS
            </p>
          ...
          <div className="mt-3 flex items-center justify-between font-mono text-xs uppercase tracking-[0.18em] text-zinc-300">
